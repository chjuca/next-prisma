...
import { FaCalendarAlt, FaClock, FaExclamationCircle, FaCheckCircle, FaBan, FaBell, FaUser  } from 'react-icons/fa';
  ...
  <div className="mb-4">
    <label className="text-gray-700 text-sm flex items-center gap-2">
      ...
      <p className={`text-gray-600 mb-2 ${isCompleted ? 'line-through' : ''}`}>
        {task.assignedTo ? task.assignedTo.name : 'No one assigned'}
      </p>
    </label>
  </div>

  {/* Fecha de creación y plazo */}
